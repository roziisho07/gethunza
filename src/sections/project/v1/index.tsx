...
export function ProjectSection({ sectionHeading, works }: ProjectSectionProps) {
  return (
    <section className="container_container__az_fT section-padding-primary overflow-hidden  ">
