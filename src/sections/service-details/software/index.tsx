...
export function ServiceDetailsSection() {
  return (
    <section className="section-padding-primary mt-20">
      <Container>
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-6">
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              <Image
                src="/assets/images/service-details/soft-1.jpg"
                alt="service image 2"
                width={640}
                height={426}
                className="rounded-5"
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    {`We create bespoke software solutions tailored to your business needs. From scalable enterprise applications to innovative startups, our software is built to optimize performance, efficiency, and growth.`}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    {`Leverage the power of AI with custom solutions that automate processes, improve decision-making, and enhance customer experiences. We integrate AI into your software to take your business to the next level.`}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    {`Enhance the security and transparency of your software with blockchain. We provide end-to-end blockchain solutions, from secure payment systems to decentralized applications (dApps).`}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              <Image
                src="/assets/images/service-details/soft-4.jpg"
                alt="service image 2"
                width={640}
                height={426}
                className="rounded-5"
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    {`We specialize in creating and integrating APIs that enhance the functionality and scalability of your software. Streamline data exchange between systems and improve overall performance.`}
                  </p>
                </div>
              </div>
            </div>
