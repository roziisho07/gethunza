...
const services: LinkProps[] = [
  ...
  {
    label: 'Smart Contact Integration',
    href: '/',
  },
];
        ...
        <div className="grid items-start gap-10 md:grid-cols-[390px_1fr] 2xl:gap-[50px]">
          ...
          <div className="grid gap-10 md:sticky md:top-[76px] lg:top-[133px] 2xl:gap-[60px]">
            ...
            <div className="grid gap-30px">
              ...
              <div className="flex items-center gap-5">
                ...
                />
                <div>
                  <h3 className="h3 text-accent-700 dark:text-white">Moiz</h3>
                  <p>CEO GETHUNZA</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-6">
            ...
            <p>
              ...
              online presence—it’s your brand’s identity. At Gethunza, we
              specialize in web development that not only looks stunning but
              also performs flawlessly, ensuring your business stands out from
              the competition.`}
            </p>
            <p>
              {`At Gethunza, we don’t just create websites; we build digital experiences that captivate and engage your audience. Our team of experienced developers and designers work closely with you to bring your vision to life, crafting a website that embodies your brand’s values. Driven by our commitment to Innovative Excellence, we approach every project with creativity, precision, and the latest technologies to deliver exceptional results.`}
            </p>
            <div className="my-10 grid items-center gap-8 md:grid-cols-2">
              ...
              <div className="grid gap-4">
                <div className="grid gap-3">
                  ...
                  <p>
                    {`Whether you're a startup or an established business, we tailor each website to your specific needs. Our custom solutions ensure that your site reflects your brand, offering a seamless and user-friendly experience.`}
                  </p>
                </div>
                <div className="grid gap-3">
                  <div className="flex items-center gap-4">
                  ...
                  <p>
                    {`With users accessing websites across multiple devices, we ensure your site is fully responsive, delivering an optimized experience whether on desktop, tablet, or mobile.`}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-2.5 grid grid-cols-[1fr_260px] gap-6">
              <div className="grid items-baseline gap-6 lg:gap-9">
                <div>
                  ...
                  <p>
                    {`We develop comprehensive e-commerce platforms that make selling online simple and efficient. From product listings to secure payment gateways, we provide all the tools you need to grow your online business.`}
                  </p>
                </div>
                <div>
                  <h3 className="text-md font-bold text-accent-700 dark:text-white">
                  ...
                  <p>
                    {
                      'Managing your website’s content should be easy. We integrate intuitive content management systems (CMS) like WordPress or build custom solutions so you can update and maintain your website effortlessly.'
                    }
                  </p>
                </div>
              </div>
              <div>
                ...
                <p>
                  {`A beautifully designed website is ineffective if it doesn’t rank on search engines. Our development process includes SEO best practices to improve visibility and drive more traffic to your site.`}
                </p>
              </div>
              <div>
                <h3 className="text-md font-bold text-accent-700 dark:text-white">
                ...
                <p>
                  {`Launching your website is just the beginning. We offer ongoing support and maintenance services to ensure your website stays secure, up-to-date, and running smoothly at all times.`}
                </p>
              </div>
            </div>
          </div>
